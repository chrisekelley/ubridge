define(['backbone', 'inflection'],function(Backbone, inflection) {
  'use strict';
  ...
  initialize: function(){
    ...
    if (typeof this.get("label") !== "undefined") {
      this.set({"name" : (typeof this.get("name") == "undefined") ? inflection.dasherize(this.get("label").toLowerCase()) : this.name});
    }
  },
  value: null,

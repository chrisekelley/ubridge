...
---------------
   ...
   Make sure to delete the database before running the tests.

      indexedDB.deleteDatabase('_pouch_troubletickets');

   I tried to include that command in the test but it throws an InvalidStateException error. I think
   [Issue 126](https://github.com/daleharvey/pouchdb/issues/126) is related.
